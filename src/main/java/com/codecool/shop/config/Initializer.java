...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Amazon Fire", new BigDecimal("97.27"), "USD", "You can use this tablet model to take photos. It is equipped with a camera with a 2 Mpix matrix, which will allow you to take great situational shots that can be published on a regular basis in social networks or saved in the archive.", tablet, amazon));
