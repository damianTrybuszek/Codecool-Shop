...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Huawei P30", new BigDecimal("317.35"), "USD", "The HUAWEI P30 sets the limit of smartphone photography. With him, you can find your artistic power and see the world from a new perspective.", smartphone, huawei));
